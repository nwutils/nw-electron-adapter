...
`getAppPath`                           | ✯✯✯✫     | Tested      | [Documentation](https://github.com/nwutils/nw-electron-adapter/blob/master/src/api/getAppPath.js)
`getPath`                              | ✯✯✯☆     | Documented  | [Documentation](https://github.com/nwutils/nw-electron-adapter/blob/master/src/api/getPath.js)
